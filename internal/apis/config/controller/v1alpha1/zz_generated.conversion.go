...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*controllerv1alpha1.GatewayAPIConfig)(nil), (*controller.GatewayAPIConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_GatewayAPIConfig_To_controller_GatewayAPIConfig(a.(*controllerv1alpha1.GatewayAPIConfig), b.(*controller.GatewayAPIConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controller.GatewayAPIConfig)(nil), (*controllerv1alpha1.GatewayAPIConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controller_GatewayAPIConfig_To_v1alpha1_GatewayAPIConfig(a.(*controller.GatewayAPIConfig), b.(*controllerv1alpha1.GatewayAPIConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_controller_ControllerConfiguration(in *controllerv1alpha1.ControllerConfiguration, out *controller.ControllerConfiguration, s conversion.Scope) error {
	...
	if err := v1.Convert_Pointer_bool_To_bool(&in.EnableGatewayAPIListenerSet, &out.EnableGatewayAPIListenerSet, s); err != nil {
		return err
	}
	...
	if err := sharedv1alpha1.Convert_v1alpha1_PEMSizeLimitsConfig_To_shared_PEMSizeLimitsConfig(&in.PEMSizeLimitsConfig, &out.PEMSizeLimitsConfig, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_GatewayAPIConfig_To_controller_GatewayAPIConfig(&in.GatewayAPIConfig, &out.GatewayAPIConfig, s); err != nil {
		return err
	}
...
func autoConvert_controller_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *controller.ControllerConfiguration, out *controllerv1alpha1.ControllerConfiguration, s conversion.Scope) error {
	...
	if err := v1.Convert_bool_To_Pointer_bool(&in.EnableGatewayAPIListenerSet, &out.EnableGatewayAPIListenerSet, s); err != nil {
		return err
	}
	out.CopiedAnnotationPrefixes = *(*[]string)(unsafe.Pointer(&in.CopiedAnnotationPrefixes))
	...
	if err := sharedv1alpha1.Convert_shared_PEMSizeLimitsConfig_To_v1alpha1_PEMSizeLimitsConfig(&in.PEMSizeLimitsConfig, &out.PEMSizeLimitsConfig, s); err != nil {
		return err
	}
	if err := Convert_controller_GatewayAPIConfig_To_v1alpha1_GatewayAPIConfig(&in.GatewayAPIConfig, &out.GatewayAPIConfig, s); err != nil {
		return err
	}
...
// Convert_v1alpha1_GatewayAPIConfig_To_controller_GatewayAPIConfig is an autogenerated conversion function.
func Convert_v1alpha1_GatewayAPIConfig_To_controller_GatewayAPIConfig(in *controllerv1alpha1.GatewayAPIConfig, out *controller.GatewayAPIConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_GatewayAPIConfig_To_controller_GatewayAPIConfig(in, out, s)
}
...
// Convert_controller_GatewayAPIConfig_To_v1alpha1_GatewayAPIConfig is an autogenerated conversion function.
func Convert_controller_GatewayAPIConfig_To_v1alpha1_GatewayAPIConfig(in *controller.GatewayAPIConfig, out *controllerv1alpha1.GatewayAPIConfig, s conversion.Scope) error {
	return autoConvert_controller_GatewayAPIConfig_To_v1alpha1_GatewayAPIConfig(in, out, s)
}
